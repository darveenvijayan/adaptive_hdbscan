...
def _hdbscan_generic(X, min_samples=5, alpha=1.0, metric='minkowski', p=2,
    ...
    print("""def _hdbscan_generic @ hdbscan_.py""")
    if metric == 'minkowski':
...
def _hdbscan_sparse_distance_matrix(X, min_samples=5, alpha=1.0,
    ...
    print("""def _hdbscan_sparse_distance_matrix @ hdbscan_.py""")
    assert issparse(X)
...
def _hdbscan_prims_balltree(X, min_samples=5, alpha=1.0,
                            metric='minkowski', p=2, leaf_size=40,
                            gen_min_span_tree=False, **kwargs):
    print("""def _hdbscan_prims_balltree @ hdbscan_.py""")
    if X.dtype != np.float64:
        X = X.astype(np.float64)
...
def _hdbscan_boruvka_balltree(X, min_samples=5, alpha=1.0,
                              ...
                              gen_min_span_tree=False,
                              core_dist_n_jobs=4, **kwargs):
    print("""def _hdbscan_boruvka_balltree @ hdbscan_.py""")
...
def check_precomputed_distance_matrix(X):
    ...
    """
    print("""def check_precomputed_distance_matrix @ hdbscan_.py""")
...
def hdbscan(X, min_cluster_size=5, min_samples=None, alpha=1.0, cluster_selection_epsilon=0.0,
    ...
    if algorithm != 'best':
        ...
        if issparse(X) or metric not in FAST_METRICS:
            print('issparse(X) or metric not in FAST_METRICS')
...
class HDBSCAN(BaseEstimator, ClusterMixin):
    ...
    def fit_predict(self, X, y=None):
        ...
        y : ndarray, shape (n_samples, )
            cluster labels
        """
        print("""def HDBSCAN.fit_predict @ hdbscan_.py""")
        self.fit(X)
        return self.labels_
    ...
    def generate_prediction_data(self):
        ...
        """
        print("""def HDBSCAN.generate_prediction_data @ hdbscan_.py""")
    ...
    def weighted_cluster_centroid(self, cluster_id):
        ...
        """
        print("""def HDBSCAN.weighted_cluster_centroid @ hdbscan_.py""")
    ...
    def weighted_cluster_medoid(self, cluster_id):
        ...
        """
        print("""def HDBSCAN.weighted_cluster_medoid @ hdbscan_.py""")
        if not hasattr(self, 'labels_'):
            raise AttributeError('Model has not been fit to data')
    ...
    def prediction_data_(self):
        print("""def HDBSCAN.prediction_data_ @ hdbscan_.py""")
    ...
    def outlier_scores_(self):
        print("""def HDBSCAN.outlier_scores_ @ hdbscan_.py""")
    ...
    def condensed_tree_(self):
        print("""def HDBSCAN.condensed_tree_ @ hdbscan_.py""")
        if self._condensed_tree is not None:
    ...
    def single_linkage_tree_(self):
        print("""def HDBSCAN.single_linkage_tree_ @ hdbscan_.py""")
    ...
    def minimum_spanning_tree_(self):
        print("""def HDBSCAN.minimum_spanning_tree_ @ hdbscan_.py""")
    ...
    @property
    def exemplars_(self):
        print("""def HDBSCAN.exemplars_ @ hdbscan_.py""")
    ...
    def relative_validity_(self):
        print("""def HDBSCAN.relative_validity_ @ hdbscan_.py""")
